...
# Utility function to draw a box
draw_box() {
...
# Function to get CPU usage and load average
get_cpu_usage() {
...
# Function to show top processes based on CPU and memory
show_top_processes() {
...
while true; do
  ...
  # Call individual functions to display system info
  get_cpu_usage
  get_memory_usage
  get_disk_usage
